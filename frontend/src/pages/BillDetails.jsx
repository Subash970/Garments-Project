              ...
              <div id="bill-container" className="border p-2">
                <div className="border-bottom">
                  ...
                  <div className="text-center mt-2">
                    ...
                    <p>{bill.userCredential && bill.userCredential.Address}</p>
                  </div>
                    ...
                    <table border={2} id="table">
                      <thead>
                        <tr>
                          ...
                          <th className="table-border">Product Description</th>
                  ...
                  <div className="mt-3 d-flex border">
                    ...
                    <div className="w-50">
                      ...
                      <div className="border p-2 d-flex">
                        <strong>SGST : </strong>
                        <span>2.5%</span>
                        <span className="ms-auto">{Math.floor(bill.SGST)}</span>
                      </div>
                      <div className="border p-2 d-flex">
                        <strong>CGST : </strong>
                        <span>2.5%</span>
                        <span className="ms-auto">{Math.floor(bill.CGST)}</span>
                      </div>
                      <div className="border p-2 d-flex">
                        <strong>Total GST : </strong>
                        <span className="ms-auto">{bill.CGST + bill.SGST}</span>
                      </div>
                      <div className="border p-2 d-flex">
